...
const unsigned int addr_ControlledNode = 0x30;            //char 1byte
...
const unsigned int addr_FlightID = 0x39;                  //Character array 16bytesmax
const unsigned int addr_EndTXEEPROMData = 0x39;           //marks the end of the stored variables
